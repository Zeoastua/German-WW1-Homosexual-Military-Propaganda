...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="tales">
        <xsl:variable name="total-English-mother-speakers" select="count(//tale[1]//dialogue[@speaker='first_queen'])"/>
        <xsl:variable name="total-English-stepmother-speakers" select="count(//tale[1]//dialogue[@speaker='second_queen'])"/>
        <xsl:variable name="total-German-mother-speakers" select="count(//tale[2]//dialogue[@speaker='queen'])"/>
        <xsl:variable name="total-German-stepmother-speakers" select="count(//tale[2]//dialogue[@speaker='queen'])"/>
        
        <xsl:variable name="positive-English-mother-speakers" select="count(//tale[1]//dialogue[@speaker='first_queen' and @stateofbeing='positive'])"/>
        <xsl:variable name="positive-English-stepmother-speakers" select="count(//tale[1]//dialogue[@speaker='second_queen' and @stateofbeing='positive'])"/>
        <xsl:variable name="positive-German-mother-speakers" select="count(//tale[2]//dialogue[@speaker='queen' and @stateofbeing='positive'])"/>
        <xsl:variable name="positive-German-stepmother-speakers" select="count(//tale[2]//dialogue[@speaker='queen' and @stateofbeing='positive'])"/>
        ...
        <xsl:variable name="negative-English-mother-speakers" select="count(//tale[1]//dialogue[@speaker='first_queen' and @stateofbeing='negative'])"/>
        <xsl:variable name="negative-English-stepmother-speakers" select="count(//tale[1]//dialogue[@speaker='second_queen' and @stateofbeing='negative'])"/>
        <xsl:variable name="negative-German-mother-speakers" select="count(//tale[2]//dialogue[@speaker='queen' and @stateofbeing='negative'])"/>
        <xsl:variable name="negative-German-stepmother-speakers" select="count(//tale[2]//dialogue[@speaker='queen' and @stateofbeing='negative'])"/>
        ...
        <xsl:variable name="neutral-English-mother-speakers" select="count(//tale[1]//dialogue[@speaker='first_queen' and @stateofbeing='neutral'])"/>
        <xsl:variable name="neutral-English-stepmother-speakers" select="count(//tale[1]//dialogue[@speaker='second_queen' and @stateofbeing='neutral'])"/>
        <xsl:variable name="neutral-German-mother-speakers" select="count(//tale[2]//dialogue[@speaker='queen' and @stateofbeing='neutral'])"/>
        <xsl:variable name="neutral-German-stepmother-speakers" select="count(//tale[2]//dialogue[@speaker='queen' and @stateofbeing='neutral'])"/>
        ...
        <text x="45" y="20" fill="black" font-size="12">FIRST</text>
        <text x="40" y="35" fill="black" font-size="12">QUEEN</text>
        ...
        <text x="112" y="20" fill="black" font-size="12">FIRST</text>
        <text x="110" y="35" fill="black" font-size="12">QUEEN</text>
        ...
        <text x="200" y="20" fill="black" font-size="12">SECOND</text>
        <text x="205" y="35" fill="black" font-size="12">QUEEN</text>
        ...
        <text x="265" y="20" fill="black" font-size="12">SECOND</text>
        <text x="267" y="35" fill="black" font-size="12">QUEEN</text>
        ...
        <text x="10" y="-270" fill="black" font-size="14">LITTLE SNOW WHITE: TYPES OF DIALOGUE SPOKEN</text>
        <text x="50" y="-255" fill="black" font-size="14">BY MOTHERS AND STEPMOTHERS</text>
