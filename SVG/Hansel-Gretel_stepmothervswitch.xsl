...
<xsl:template match="tales">
    <xsl:variable name="total-English-stepmother-speakers" select="count(//tale[1]//dialogue[@speaker='wife'])"/>
    <xsl:variable name="total-English-witch-speakers" select="count(//tale[1]//dialogue[@speaker='evil woman'])"/>
    <xsl:variable name="total-German-stepmother-speakers" select="count(//tale[2]//dialogue[@speaker='wife'])"/>
    <xsl:variable name="total-German-witch-speakers" select="count(//tale[2]//dialogue[@speaker='witch'])"/>
    
    <xsl:variable name="positive-English-stepmother-speakers" select="count(//tale[1]//dialogue[@speaker='wife' and @stateofbeing='positive'])"/>
    ...
    <xsl:variable name="positive-German-stepmother-speakers" select="count(//tale[2]//dialogue[@speaker='wife' and @stateofbeing='positive'])"/>
    <xsl:variable name="positive-German-witch-speakers" select="count(//tale[2]//dialogue[@speaker='witch' and @stateofbeing='positive'])"/>
    ...
    <xsl:variable name="negative-English-stepmother-speakers" select="count(//tale[1]//dialogue[@speaker='wife' and @stateofbeing='negative'])"/>
    ...
    <xsl:variable name="negative-German-stepmother-speakers" select="count(//tale[2]//dialogue[@speaker='wife' and @stateofbeing='negative'])"/>
    <xsl:variable name="negative-German-witch-speakers" select="count(//tale[2]//dialogue[@speaker='witch' and @stateofbeing='negative'])"/>
    ...
    <xsl:variable name="neutral-English-stepmother-speakers" select="count(//tale[1]//dialogue[@speaker='wife' and @stateofbeing='neutral'])"/>
    ...
    <xsl:variable name="neutral-German-stepmother-speakers" select="count(//tale[2]//dialogue[@speaker='wife' and @stateofbeing='neutral'])"/>
    <xsl:variable name="neutral-German-witch-speakers" select="count(//tale[2]//dialogue[@speaker='witch' and @stateofbeing='neutral'])"/>
    ...
    <rect x="60" y="-{$positive-English-stepmother-speakers-percent * $yscale}" height="{$positive-English-stepmother-speakers-percent * $yscale}" width="{$bar-width}" fill="#75333a"/>
    <rect x="60" y="{($max-height * $yscale) + ($negative-English-stepmother-speakers-percent * $yscale)}" height="{$neutral-English-stepmother-speakers-percent * $yscale}" width="{$bar-width}" fill="#a25c29"/>
    <rect x="60" y="{$max-height * $yscale}" height="{$negative-English-stepmother-speakers-percent * $yscale}" width="{$bar-width}" fill="#446460"/>
    
    <text x="50" y="20" fill="black" font-size="12">STEP-</text>
    <text x="40" y="35" fill="black" font-size="12">MOTHER</text>
    <text x="40" y="50" fill="black" font-size="10">(ENGLISH)</text>
  
    
    <rect x="120" y="-{$positive-German-stepmother-speakers-percent * $yscale}" height="{$positive-German-stepmother-speakers-percent * $yscale}" width="{$bar-width}" fill="#75333a"/>
    <rect x="120" y="{($max-height * $yscale) + ($negative-German-stepmother-speakers-percent * $yscale)}" height="{$neutral-German-stepmother-speakers-percent * $yscale}" width="{$bar-width}" fill="#a25c29"/>
    <rect x="120" y="{$max-height * $yscale}" height="{$negative-German-stepmother-speakers-percent * $yscale}" width="{$bar-width}" fill="#446460"/>
    
    <text x="110" y="20" fill="black" font-size="12">STEP-</text>
    <text x="105" y="35" fill="black" font-size="12">MOTHER</text>
    ...
    <text x="212" y="20" fill="black" font-size="12">WITCH</text>
    ...
    <text x="272" y="20" fill="black" font-size="12">WITCH</text>
    ...
    <text x="5" y="-270" fill="black" font-size="14">HANSEL AND GRETEL: TYPES OF DIALOGUE SPOKEN</text>
    <text x="60" y="-255" fill="black" font-size="14">BY STEPMOTHERS AND WITCHES</text>
